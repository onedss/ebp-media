...
public:
  ...
  void assignHandler(int socketNum, int mask, TaskScheduler::BackgroundHandlerProc* handlerProc, void* clientData, void* eventBase);
  void clearHandler(int socketNum);
  void moveHandler(int oldSocketNum, int newSocketNum, void* eventBase);
