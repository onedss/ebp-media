...
public:
  ...
  virtual TaskToken scheduleDelayedTask(int64_t microseconds, TaskFunc* proc,
					void* clientData, bool persistent = false) = 0;
  ...
  typedef void BackgroundHandlerProc(void* clientData, int mask);
    ...
    #define SOCKET_READABLE    0x02
    #define SOCKET_WRITABLE    0x04
  virtual void setBackgroundHandling(int socketNum, int mask, BackgroundHandlerProc* handlerProc, void* clientData) = 0;
